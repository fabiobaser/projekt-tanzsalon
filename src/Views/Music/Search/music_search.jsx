...
export class MusicSearch extends Component {
  ...
  /**
   * Updtate Search-Query on Tag Change
   * @param  {Object} e    Synthetic Event
   * @param  {String} name Name of clicked tag
   */
  ...
  /**
   * Sorts Table-Column on click
   * @param  {String} clickedColumn Get name of selected column
   */
   ...
   * @param  {Object} e    Synthetic Event
   * @param  {Object} data Data of Input Field
   */
  ...
  render() {
    let { data, column, direction, inputValue, searchDances } = this.state;
